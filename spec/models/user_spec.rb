...
RSpec.describe User, type: :model do
  ...
  describe "Validations" do
    ...
    it 'requires the phoen attr to only contain integers' do
    ...
    it 'requires a ssn attr' do
      @user.ssn = nil
      expect(@user).to_not be_valid
    end

    it 'requrires a company' do
      @user.company = nil
      expect(@user).to_not be_valid
    end
    ...
    it 'requires the phone attr to only have 4 chars' do
      @user.ssn = '12345'
      expect(@user).to_not be_valid
    end    
  ...
  describe 'relation between admins and employees' do
